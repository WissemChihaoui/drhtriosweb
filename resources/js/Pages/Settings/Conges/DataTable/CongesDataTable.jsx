...
const CongesDataTable = ({ products, setProducts, productDialog, setProductDialog, product, setProduct }) => {
    ...
    const editProduct = (product) => {
        ...
        console.log('from datatable',product);
    };
    ...
    const deleteProduct = (e) => {
        ...
        if (product && product.id) {
                destroy(route("conges.destroy", product.id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        setProducts(
                            products.filter(
    ...
    const deleteSelectedProducts = () => {
        ...
        post(route("conges.destroyMultiple"), {
    ...
    return (
        <div>
            ...
            <Dialog
                ...
                header="Supprimer type de congé"
                modal
            ...
            <Dialog
                ...
                style={{ width: "32rem" }}
                breakpoints={{ "960px": "75vw", "641px": "90vw" }}
                header="Supprimer les types de congés"
                modal
            ...
            >
                <div className="confirmation-content">
                    ...
                    {product && (
                        <span>
                            Êtes-vous sûr de vouloir supprimer les types des congés sélectionnés ?
                        </span>
                    )}
                </div>
            </Dialog>
...
export default CongesDataTable