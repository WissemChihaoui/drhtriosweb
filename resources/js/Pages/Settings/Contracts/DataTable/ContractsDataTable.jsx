...
const ContractsDataTable = ({ products, setProducts, productDialog, setProductDialog, product, setProduct }) => {
    ...
    const deleteProduct = (e) => {
        ...
        if (product && product.id) {
                destroy(route("contracts.destroy", product.id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        setProducts(
                            products.filter(
    ...
    const deleteSelectedProducts = () => {
        ...
        post(route("contracts.destroyMultiple"), {
    ...
    return (
        <div>
            ...
            <Dialog
                ...
                header="Supprimer type de contrat"
                modal
            ...
            <Dialog
                ...
                style={{ width: "32rem" }}
                breakpoints={{ "960px": "75vw", "641px": "90vw" }}
                header="Supprimer les types de contrats"
                modal
            ...
            >
                <div className="confirmation-content">
                    ...
                    {product && (
                        <span>
                            Êtes-vous sûr de vouloir supprimer les types des contrats sélectionnés ?
                        </span>
                    )}
                </div>
            </Dialog>
