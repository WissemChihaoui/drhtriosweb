...
const CategoriesDataTable = ({ products, setProducts, productDialog, setProductDialog, product, setProduct }) => {
    ...
    const deleteProduct = (e) => {
        ...
        if (product && product.id) {
                destroy(route("categories.destroy", product.id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        setProducts(
                            products.filter(
                        ...
                        toast.current.show({
                            severity: "success",
                            summary: "Supprimé",
                            detail: "Catégorie a été Supprimé",
                            life: 3000,
                        });
    ...
    const deleteSelectedProducts = () => {
        ...
        post(route("categories.destroyMultiple"), {
