...
export default function DepartementDataTable({departements}) {
    let emptyProduct = {
        id: null,
        name: '',
        image: null,
    ...
    const leftToolbarTemplate = () => {
        return (
            <div className="flex flex-wrap gap-2">
                <Link href={route('worker.add.page')} className='btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white'>Ajouter département</Link>
        ...
        <div>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="nom_departement" header="Département" sortable style={{ minWidth: '16rem' }}></Column>
